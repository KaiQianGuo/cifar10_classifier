...
# 创建输出目录
output_dir = "/home/zhengweiguo/q2q2p/cifar10_classifier/logs/search_logs_Relu"
...
for idx, (hidden_dim, lr, reg) in enumerate(product(hidden_dims, learning_rates, regularizations)):
    ...
    net = ThreeLayerNet(input_size, hidden_dim, output_size, activation='relu', reg_lambda=reg)
